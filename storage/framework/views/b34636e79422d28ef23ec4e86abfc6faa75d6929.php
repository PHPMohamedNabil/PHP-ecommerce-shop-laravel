...
<div class="container">
        ...
        <div class="row">
            <aside class="col-sm-5 border-right">
                <section id="" class="gallery-wrap">
                    <div class="img-big-wrap">
                        <a href="#">
                            <img src="<?php echo e(Storage::url($product->img)); ?>" width="100%">
                        </a>
                    </div>
                </section>
            ...
            <aside class="col-sm-7">
                <section class="card-body p-5">
                    ...
                    <div class="row">
                        <hr>
                        <a  href="<?php echo e(route('add_to_cart',$product->id)); ?>" class="btn btn-lg btn-outline-primary text-uppercase">
                            Add to cart
                        </a>
                    </div>
                </section>
    ...
    <?php if(count($recommand) >0): ?>
<div class="jumbotron mt-3">
    <h2>You May Also Like</h2>
    <div class="row">
      <?php $__currentLoopData = $recommand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <div class="col-md-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel_projects\laptops\resources\views/product_show.blade.php ENDPATH**/ ?>